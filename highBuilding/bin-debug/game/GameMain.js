...
var GameMain = (function (_super) {
    ...
    GameMain.prototype.init2 = function () {
        //创建world
        ...
        function leftRo() {
            egret.Tween.get(display, { loop: false }).to({ rotation: 90 + 45 }, 2000, egret.Ease.sineIn).call(function () {
                egret.Tween.removeTweens(display);
                // rightRo();
            });
        }
        function rightRo() {
            egret.Tween.get(display, { loop: false }).to({ rotation: -45 - 90 }, 2000, egret.Ease.sineIn).call(function () {
                egret.Tween.removeTweens(display);
                // leftRo();
            });
            egret.Tween.get(self).to({ fact: 1 }, 2000).call(function () {
            });
        }
     ...
     */
    GameMain.prototype.createBitmapByName = function (name) {
